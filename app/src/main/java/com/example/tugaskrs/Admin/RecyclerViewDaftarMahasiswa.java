...
public class RecyclerViewDaftarMahasiswa extends AppCompatActivity {
    ...
    private void tambahData(){
        ...
        mhsList.add(new Mahasiswa("72170126","DESTA","desta.siwi@si.ukdw.ac.id","Kebumen",R.drawable.logoku));
        mhsList.add(new Mahasiswa("72170172","PUTU","abdi@si.ukdw.ac.id","Bali",R.drawable.logoku));
        mhsList.add(new Mahasiswa("72170106","DEO","deo@si.ukdw.ac.id","Bengkayang",R.drawable.logoku));
    }
}
